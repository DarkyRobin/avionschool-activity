...
//     country: 'Philippines'
//   };
//   console.log(`${newAddress.street}, ${newAddress.city}, ${newAddress.country}`);
...
// const buyFood = (food = 'De Lata') => {
//   console.log(`I want to buy ${food} from the Sare-Sare store.`);
// }
// buyFood();
// buyFood('sumthin');
